...
class _LoginScreenState extends ConsumerState<LoginScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: AppColors.surfaceVariant, // Sleek slate-50 background
      body: Stack(
        children: [
              ...
              child: Container(
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0xFFE0F2FE), Color(0xFFF8FAFC)], // Very soft blue gradient
          ...
          // ── Curved White Bottom Sheet Form ──────────────────────────────────
          Align(

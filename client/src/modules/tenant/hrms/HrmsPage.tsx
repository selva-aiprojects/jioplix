  ...
  return (
    ...
    <div className="dashboard-layout">
      ...
      <main className="main-content">
        <Header title="Human Resource Management System" subtitle="Duty roster, shift management, attendance, on-call scheduling, staff credentials & clinical privileges" />
          ...
          <div style={{ background: "#ffffff", borderRadius: "20px", border: "1px solid #e2e8f0", padding: "16px 20px", marginBottom: "24px", boxShadow: "0 4px 16px -4px rgba(0,0,0,0.04)", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
            <div style={{ display: "flex", gap: "10px", flex: 1, minWidth: "300px", flexWrap: "wrap" }}>
              <div style={{ position: "relative", flex: 1, minWidth: "180px" }}>
                ...
                <input type="text" placeholder="Search staff, department, shift..." style={{ width: "100%", padding: "9px 14px 9px 38px", border: "1px solid #cbd5e1", borderRadius: "12px", fontSize: "13px", background: "#f8fafc" }} />
              </div>
